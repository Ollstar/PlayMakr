...
@interface PMRSkillDetailsFooterView ()
@property (nonatomic, strong) UIView *mainView;
@end

@implementation PMRSkillDetailsFooterView
...
- (void)drawRect:(CGRect)rect {
    ...
    if (!hideDropShadow) {
        [PMUtility drawSideAndBottomDropShadowForRect:mainView.frame inContext:UIGraphicsGetCurrentContext()];
    }
}


#pragma mark - PAMSkillDetailsFooterView
