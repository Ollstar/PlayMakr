...
@implementation PMRHomeViewController
...
- (void)settingsButtonAction:(id)sender {
    self.settingsActionSheetDelegate = [[PMRSettingsActionSheetDelegate alloc] initWithNavigationController:self.navigationController];
